...
var model = {
  ...
  columns: {
	...
	"HEN 4.74": {
      ...
      active: false,
      icon: 'gamepad',
      items: [{ title: "HEN 1.0", desc: "Inc: self spawn & usermode printf to klog patches", version: "4.74 by Zecoxao", active: false, icon: "lock", expage: "payloads/PS4Brew4.74.html" }]
  },
  "HEN 5.05": {
      index: 2,
      title: "HEN 5.05",
