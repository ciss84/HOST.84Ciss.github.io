...
var model = {
  ...
  "GTAV MENUS": {
   ...
   "★DEBUG": {
      ...
      selectedIndex: 0,
      icon: "grade",
      items: [{title:"★PAYLOAD", desc:"Test experimental payloads", version:"1.0 by DEFAULTDNB", icon:"", expage:"payloads/test.html"}]
	},    
  }
...
window.onkeyup = function(e) {
   ...
   window.open("payloads/hen212.html", "content");
   } else if (key == 117) {
   window.open("payloads/hen19ftp.html", "content");
   } else if (key == 119) {
