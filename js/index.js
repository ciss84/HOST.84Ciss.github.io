...
var model = {
  ...
  columns: {
	 "QUICK": {
      ...
      icon: 'style',
<<<<<<< HEAD
      items: [{title:"Mira Loader Usb", desc:"Enable only ELF LOADER function on Usb port", version:"1.1 by Lightningmods", icon:"send", expage:"payloads/mira2.html"}, {title:"FTP + FULL R/W", desc:"Starts an ftp server with full R/W on all 16 partitions of your PS4", version:"1.0 by Lightningmods", icon:"warning", expage:"payloads/ftprw.html"}, {title:"webrte2", desc:"Enable web rte 2 droid", version:"?", icon:"send", expage:"payloads/webrte2.html"}, {title:"WEB-RTE PS4 TRAINER", desc:"Use http://ps4trainer.com/trainer + enter your PS4 IP", version:"1.00 by TylerMods", icon:"whatshot", expage:"payloads/WebRTE.html"}, {title:"PS4 Trainer", desc:"PS4 Trainer", version:"1.0 by ", icon:"?", expage:"payloads/PS4Trainer.html"}, { title:"★Debug_MiraHen 1", desc:"Furst load ps4debug 1.5 payloads", version:"ps4debug 1.5", icon:"lock", expage:"payloads/ps4debug15.html"}, { title: "★MiraHen 2", desc: "Second load miraCfw patches", version: "by specterdev", icon: "lock", expage: "payloads/PS4Brew5.05.html" }, { title:"★Hen 2.1.4", desc:"Inc: 7.50 PSVR spoof, Debug Trophies Support, Enable UART, Remote Play Enabler", version:"2.1.3 by SiSTRo", icon:"", expage:"payloads/Hen213.html"}, { title: "DUMPER", desc: "Dump disc/PSN games to USB: with/without patches, merged/unmerged", version: "1.8 by xVortex", active: false, icon: "archive", expage: "payloads/vtxdump.html"}, { title: "BINLOADER", desc: "Enable only BIN LOADER function on port:9020", version: "1.7 by OpenOrbisTeam", active: false, icon: "send", expage: "payloads/binloader.html" }]
=======
      items: [{title:"Mira Loader Usb", desc:"Enable only ELF LOADER function on Usb port", version:"1.1 by Lightningmods", icon:"send", expage:"payloads/mira2.html"}, {title:"FTP + FULL R/W", desc:"Starts an ftp server with full R/W on all 16 partitions of your PS4", version:"1.0 by Lightningmods", icon:"warning", expage:"payloads/ftprw.html"}, {title:"WEB-RTE PS4 TRAINER", desc:"Use http://ps4trainer.com/trainer + enter your PS4 IP", version:"1.00 by TylerMods", icon:"whatshot", expage:"payloads/WebRTE.html"}, {title:"PS4 Trainer", desc:"PS4 Trainer", version:"1.0 by ", icon:"?", expage:"payloads/PS4Trainer.html"}, { title:"★Debug_MiraHen 1", desc:"Furst load ps4debug 1.5 payloads", version:"ps4debug 1.5", icon:"lock", expage:"payloads/ps4debug15.html"}, { title: "★MiraHen 2", desc: "Second load miraCfw patches", version: "by specterdev", icon: "lock", expage: "payloads/PS4Brew5.05.html" }, { title:"★Hen 2.1.4", desc:"Inc: 7.50 PSVR spoof, Debug Trophies Support, Enable UART, Remote Play Enabler", version:"2.1.3 by SiSTRo", icon:"", expage:"payloads/Hen213.html"}, { title: "DUMPER", desc: "Dump disc/PSN games to USB: with/without patches, merged/unmerged", version: "1.8 by xVortex", active: false, icon: "archive", expage: "payloads/vtxdump.html"}, { title: "BINLOADER", desc: "Enable only BIN LOADER function on port:9020", version: "1.7 by OpenOrbisTeam", active: false, icon: "send", expage: "payloads/binloader.html" }]
>>>>>>> 3d95d56ddc1a89767bd8bdf0e70a25217a7e6847
  },    
  "HEN": {
      index: 1,
      title: "HEN",
